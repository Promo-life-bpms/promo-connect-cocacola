...
class CotizadorController extends Controller
{
    ...
    public function verProducto(Product $product)
    {
        ...
        // Obtener 5 productos aleatorios que coincidan con la categoría y excluyendo las de 'textil'
        ...
        return view('pages.catalogo.product', compact('product', 'utilidad', "msg", 'recommendedProducts'));
    }
