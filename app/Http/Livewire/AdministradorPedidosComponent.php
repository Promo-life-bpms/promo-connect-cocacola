...
class AdministradorPedidosComponent extends Component
{
    ...
    public function render()
    {
        ...
        $userproducts = Muestra::join('users', 'users.id', 'muestras.user_id')
            ...
            ->select('users.name as user_name', 'products.name as product_name as product_name', 'muestras.updated_at', 'muestras.address',  'muestras.status', 'muestras.current_quote_id', 'muestras.id as id_muestra', 'muestras.type as product_type', 'muestras.estimated_delivery as estimated_delivery')
