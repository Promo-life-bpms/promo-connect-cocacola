        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 mt-8">
            ...
            <div class="flex flex-col items-center transition-transform duration-300 hover:scale-105 cursor-pointer">
                <a href="{{ route('categoryfilter', ['category' => 9]) }}">
                    <div class="w-[211px] h-[211px] bg-secondary flex items-center justify-center rounded-lg">
                ...
                <p class="text-center text-lg font-TCCCUnityHeadline font-normal text-secondary mt-4">BEBIDAS</p>
            </div>
            ...
            <div class="flex flex-col items-center transition-transform duration-300 hover:scale-105 cursor-pointer">
                ...
                <p class="text-center text-lg font-TCCCUnityHeadline font-normal text-secondary mt-4">OFICINA</p>
            </div>
            ...
            <div class="flex flex-col items-center transition-transform duration-300 hover:scale-105 cursor-pointer">
                ...
                <p class="text-center text-lg font-TCCCUnityHeadline font-normal text-secondary mt-4">ESCRITURA</p>
            </div>
            ...
            <div class="flex flex-col items-center transition-transform duration-300 hover:scale-105 cursor-pointer">
                ...
                <p class="text-center text-lg font-TCCCUnityHeadline font-normal text-secondary mt-4">SALUD</p>
            </div>
            ...
            <div class="flex flex-col items-center transition-transform duration-300 hover:scale-105 cursor-pointer">
                ...
                <p class="text-center text-lg font-TCCCUnityHeadline font-normal text-secondary mt-4">CUIDADO PERSONAL</p>
            </div>
            ...
            <div class="flex flex-col items-center transition-transform duration-300 hover:scale-105 cursor-pointer">
                ...
                <p class="text-center text-lg font-TCCCUnityHeadline font-normal text-secondary mt-4">TECNOLOGÍA</p>
            </div>
