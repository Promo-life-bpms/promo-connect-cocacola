                        ...
                        <ul class="flex flex-wrap  text-sm text-center text-gray-500 dark:text-gray-400">
                            ...
                            <li class="mr-2">
                                <a href="#"
                                    ...
                                    {{ $quote->status >= 0 ? 'text-black' : 'text-[#B3B2B2]' }}
                                    {{ $quote->status === 0 ? 'border-black' : 'border-transparent' }}">
                                    <div
                                        class="rounded-full  text-[#F2F2F2] h-6 w-6 mr-2 flex justify-center pt-[0.5px]
                                        {{ $quote->status >= 0 ? 'bg-black' : 'bg-[#B3B2B2] ' }}">
                                        1
                                    </div>
                            ...
                            <li class="mr-2">
                                <a href="#"
                                    class="inline-flex p-1 px-2 border-b-2  rounded-t-lg
                                    {{ $quote->status >= 1 ? 'text-black border-black' : 'text-[#B3B2B2]' }}
                ...
                <div class="flex-grow space-y-3">
                    <div class="flex items-center space-x-3 mt-2">
                        ...
                        <select wire:model="quoteStatus"
                            ...
                            <option value="0">En validación OC</option>
                            <option value="1">En proceso de compra</option>
                            <option value="2">Error en número de compra</option>
