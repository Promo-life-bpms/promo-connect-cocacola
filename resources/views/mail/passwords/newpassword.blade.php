...
<head>
    ...
    <title>Bienvenido al sistema HH GLOBAL</title>
    <style>
        /* Estilos generales */
        body {
...
<body>
    <div class="container">
        <div class="inner-container">
            ...
            @component('mail::button', ['url' => 'https://dev-promocionales-hhglobal.promo-connect.com.mx/login', 'color' => 'blue'])
            Inicia sesión
            @endcomponent
        </div>
        <div class="bpms-legend">
            HH GLOBAL. Todos los derechos reservados.
        </div>
    </div>
</body>
</html>