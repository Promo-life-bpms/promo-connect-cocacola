                        ...
                        <div class="card-body">
                            <div class="bg-white mx-auto h-auto w-full grid md:grid-cols-2 p-3 gap-y-2">
                                ...
                                <div class="relative  md:col-span-2  lg:mx-32 lg:mt-2 ">
                                    <h1 class="font-semibold text-2xl">Informacion Del Usuario</h1>
                                    <div>
                                    ...
                                    <div class="relative" wire:loading.class="opacity-70">
                                        ...
                                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                            <thead class="text-xs text-white bg-black ">
                                                <tr>
                                                    <th scope="col" class="px-3 py-2 md:px-6  md:py-3 py-2">
                                                        Nombre
                                                    </th>
                                                        ...
                                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                            ...
                                                            <td class="w-[15%]">
                                                                ...
                                                                <a href="{{ route('verCotizacion', ['quote' => $compra->id]) }}"
                                                                    class="btn-sm"> <button
                                                                        class="bg-black text-white hover:bg-primary hover:text-black font-bold w-full px-2 py-2">VER
                                                                        COMPRA</button>
                                                                </a>
                                                            </td>
