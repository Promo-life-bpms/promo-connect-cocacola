                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    <form action="{{ route('view.stadisticsFilter') }}" method="POST">
                                        ...
                                        <div class="flex items-center justify-end">
                                            <button type="submit" class="text-black bg-primary hover:bg-black hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Filtrar</button>
